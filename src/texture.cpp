...
int main()
{
    ...
    Shader ourShader("/home/xl/src/cpp/OPENGL/shader/vertex_texture.glsl",
                "/home/xl/src/cpp/OPENGL/shader/fragment_texture.glsl");
    ...
    unsigned char *data = stbi_load("/home/xl/src/cpp/OPENGL/img/container.jpg", &imagewidth, &imageheight, &nrChannels, 0);
    if (data)
    {
    ...
    //加载图片
    data = stbi_load("/home/xl/src/cpp/OPENGL/img/awesomeface.png", &imagewidth, &imageheight, &nrChannels, 0);
