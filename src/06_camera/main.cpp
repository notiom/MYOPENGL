...
int main(int argc, char *argv[])
{
  ...
  Shader ourShader("./src/06_camera/shader/vertex.glsl", "./src/06_camera/shader/fragment.glsl");
  ...
  unsigned char *data = stbi_load("./src/06_camera/img/container.jpg", &width, &height, &nrChannels, 0);
  ...
  // 加载图片
  data = stbi_load("./src/06_camera/img/awesomeface.png", &width, &height, &nrChannels, 0);
