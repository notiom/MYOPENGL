...
int main()
{
    ...
    Shader ourShader("./src/02_load_texture/shader/vertex.glsl",
                "./src/02_load_texture/shader/fragment.glsl");
    ...
    unsigned char *data = stbi_load("./src/02_load_texture/img/container.jpg", &imagewidth, &imageheight, &nrChannels, 0);
    if (data)
    {
    ...
    //加载图片
    data = stbi_load("./src/02_load_texture/img/awesomeface.png", &imagewidth, &imageheight, &nrChannels, 0);
