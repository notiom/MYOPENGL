...
int main(int argc, char *argv[])
{
  ...
  Shader ourShader("./src/06_box_plan_sphere/shader/vertex.glsl", 
                  "./src/06_box_plan_sphere/shader/fragment.glsl");
  ...
  unsigned char *data = stbi_load("./src/06_box_plan_sphere/img/container.jpg", &width, &height, &nrChannels, 0);
  ...
  // 加载图片
  data = stbi_load("./src/06_box_plan_sphere/img/awesomeface.png", &width, &height, &nrChannels, 0);
